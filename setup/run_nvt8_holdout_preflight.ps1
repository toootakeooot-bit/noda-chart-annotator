...
Write-Host 'Expected current result: BLOCKED_NO_CLEAN_SOURCE_LEVEL_HOLDOUT if all NVT7/NVT7.1 prerequisites pass but no unseen teacher video is registered.'
Write-Host 'A BLOCKED research result is not an execution failure.'
