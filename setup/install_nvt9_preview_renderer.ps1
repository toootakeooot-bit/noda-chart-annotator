...
$Target = Join-Path $Scripts 'NCA_NVT9_Preview_Renderer.mq4'
Copy-Item (Join-Path $RepoRoot 'mt4\NCA_NVT9_Preview_Renderer.mq4') $Target -Force
...
Write-Host 'NVT9 PREVIEW RENDERER INSTALL PASS'
Write-Host "DataFolder: $DataFolder"
Write-Host "Target:     $Target"
Write-Host 'Object ownership prefix: NVT9_PREVIEW__'
