...
| Judgment owner | **ChatGPT judges what to draw; MT4① receives and renders the drawing instruction** | FIXED |
...
7. ChatGPT owns the drawing judgment. MT4① is the rendering destination, not the strategy/judgment owner.
...
- any wording that assigns drawing judgment ownership away from ChatGPT.
